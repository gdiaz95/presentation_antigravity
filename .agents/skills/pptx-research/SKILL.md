---
name: pptx-research
description: "A user may ask you to create, edit, or analyze the contents of a .pptx file. This skill extends pptx-official with research-presentation conventions: author name positioned lower on the title slide, mandatory Acknowledgments last slide, and enforced bullet-point lists on all non-title slides."
risk: unknown
source: community
...
.subtitle-container {
  margin-top: 38pt;   /* ↑ increased from 20pt — pushes author name lower */
  text-align: center;
}
.perspective-text {
  color: #000000; font-size: 20pt; font-style: italic; font-weight: bold; margin: 0 0 14pt 0;
}
.author-text {
...
> **MANDATORY (pptx-research)**: Every non-title slide MUST present its content as bullet points using `<ul><li>` elements. Plain paragraphs, numbered lists, or dash-lists are **not permitted** on content slides. This rule applies to ALL slides except the title slide.
...
> - [ ] 3–5 bullets using `<ul><li>` — NO plain `<p>` body text, NO dashes, NO numbered lists
...
## Acknowledgments Slide (MANDATORY — always last)

> **MANDATORY (pptx-research)**: Every presentation generated with this skill MUST include an **Acknowledgments slide as the very last slide**. Do not omit it, even for short presentations.

This slide follows the layout shown in the reference image:
- **Title**: "Acknowledgments" — bold, large, centered at the top
- **Body**: 4 bullet points using `<ul><li>`, left-aligned, ~20pt, black text. Bold/inline emphasis allowed.
- **Footer**: 2–3 institutional logos placed side by side at the bottom-left, same height (~50pt)
- **Slide number**: bottom-right corner

### Content Template for Acknowledgments

Adapt the following content to the presenter's actual situation:

1. *Thank you for your time and attention.*
2. *I gratefully acknowledge **[Advisor Name]** (advisor), **[Mentor Name]** (postdoctoral mentor), as well as my **family, friends, and [partner]** for their unconditional support.*
3. *Special thanks to the **[Program/Department]** at **[Institution]**.*
4. *I welcome any questions.*

> Ask the user for their advisor name, institution, and logos if not already known. Use `generate_image` for logos if not available locally.

### HTML Template for Acknowledgments Slide
...
.slide-title {
  text-align: center;
  padding: 22pt 40pt 10pt 40pt;
}
h1 {
  color: #000000; font-size: 36pt; font-weight: bold;
  margin: 0; line-height: 1.15;
}
.body-area {
  flex: 1;
  padding: 10pt 40pt 60pt 40pt;
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
}
ul {
  margin: 0; padding-left: 28pt;
  list-style-type: disc;
}
li {
  color: #000000; font-size: 20pt; line-height: 1.35;
...
.logos-row {
  position: absolute;
  bottom: 14pt; left: 20pt;
  display: flex; flex-direction: row; align-items: center;
  gap: 20pt;
}
.logo-img {
  height: 50pt; width: auto; object-fit: contain;
}
.slide-number {
  position: absolute;
  bottom: 10pt; right: 20pt;
...
<body>
  ...
  <div class="body-area">
    <ul>
      ...
      <li>I gratefully acknowledge <span class="bold-em">[Advisor Name]</span> (advisor),
          <span class="bold-em">[Mentor Name]</span> (postdoctoral mentor), as well as my
          <span class="bold-em">family, friends, and [partner]</span> for their unconditional support.</li>
      <li>Special thanks to the <span class="bold-em">[Program]</span> and
          <span class="bold-em">[Department]</span> at <span class="bold-em">[Institution].</span></li>
      <li>I welcome any questions.</li>
    </ul>
  </div>

  <div class="logos-row">
    <!-- Insert 2–3 institutional logo images here -->
    <img src="<!-- PATH TO LOGO 1 -->" class="logo-img" />
    <img src="<!-- PATH TO LOGO 2 -->" class="logo-img" />
    <!-- <img src="<!-- PATH TO LOGO 3 -->" class="logo-img" /> -->
  </div>
...
> **Note**: Replace all `<!-- ... -->` placeholders with actual content. Always include at least 2 logos. Bold key names inline using `<span class="bold-em">`. Adjust the slide number to be the last slide's number.
